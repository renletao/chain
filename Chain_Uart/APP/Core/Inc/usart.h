...
extern __IO uint8_t g_uart_in_buf_status;  // Status of the uart_in buffer, used in polling mode
extern __IO uint8_t g_uart_out_buf_status;  // Status of the uart_out buffer, used in polling mode
