...
../Core/Chain_Function/tof_function.c 

OBJS += \
./Core/Chain_Function/base_function.o \
./Core/Chain_Function/tof_function.o 

C_DEPS += \
./Core/Chain_Function/base_function.d \
./Core/Chain_Function/tof_function.d 
...
clean-Core-2f-Chain_Function:
	-$(RM) ./Core/Chain_Function/base_function.cyclo ./Core/Chain_Function/base_function.d ./Core/Chain_Function/base_function.o ./Core/Chain_Function/base_function.su ./Core/Chain_Function/tof_function.cyclo ./Core/Chain_Function/tof_function.d ./Core/Chain_Function/tof_function.o ./Core/Chain_Function/tof_function.su
